...
Last revised: 2026-08-14 AEST (Slice 1C-B Runtime catalog cutover)
...
`SubmitSemanticEvent` now resolves catalog outcomes, although shipped adapter
callers do not move until Slice 1D-A.
