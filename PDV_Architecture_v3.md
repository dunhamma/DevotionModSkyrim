...
The current full bridge verifier result is `PASS=1183, INFO=28`, with no
...
is clean at `PASS=1183, INFO=28`, with no `FAIL`, `WARN`, or `TODO`.

Remaining Phase 18/Nord work is runtime matrix proof on a fresh save, not record
authoring: Player page, Developer Options persistence, Survey broad/focused
states, Hircine/werewolf tension, vampire suppression/cure scar, save/load, and
