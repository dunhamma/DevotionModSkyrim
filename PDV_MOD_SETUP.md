...
| `references/authoring/PDV_Phase21_DoD_AuthorHandoff.md` | Diaries of Dibella compatibility handoff: Wintersun removal set, load-order placement, no-ESP rationale, extensibility boundary, and smoke checklist |
| `references/authoring/PDV_Phase21_DoD_CompatibilityPackage.manifest.json` | Diaries of Dibella package manifest for local evidence, disabled Wintersun-family plugins, shrine readback, and future adapter scope |
