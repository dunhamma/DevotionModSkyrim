...
This is a trusted-tester integration package. Machine/readback checks pass, but
public Authoria support is not claimed until runtime smoke and maintainer
