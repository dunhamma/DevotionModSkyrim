...
const ROUNDTRIP_PATH = path.join(ROOT, "outputs", "PDV_Accessible_Prose_Workbook_2026-08-24", "canonical-roundtrip-source.csv");
const DISPOSITION_PATH = path.join(ROOT, "outputs", "PDV_Accessible_Prose_Workbook_2026-08-24", "reference-disposition-audit.json");
