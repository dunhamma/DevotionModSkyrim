...
[
    ...
    S("PDV_FLST_Faucet_Vaermina_Artifact",
        A(0x035066, "Skull of Corruption")),
    S("PDV_FLST_Faucet_Boethiah_Artifact",
        A(0x052794, "Ebony Mail")),
    S("PDV_FLST_Faucet_Mephala_Artifact",
        A(0x04A38F, "Ebony Blade")),
    S("PDV_FLST_Faucet_Malacath_Artifact",
        A(0x02ACD2, "Volendrung")),
