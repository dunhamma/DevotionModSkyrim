...
function verifyManager(text, filePath, pass, fail) {
  const requiredSnippets = [
    ...
    ["Khajiit Champion pin", 'SurfaceTransition("tier", deity.DeityName + " " + GetPublicTierBand(TIER_CHAMPION), "reach", deity.DeityIndex, "", false, true)', "Khajiit Champion Chronicle entry is pinned and banded."],
    ...
    ["Offer accept surface", 'DispatchDiegeticCue("offer", deity.DeityName, "accept", deity, "reverent")', "Commitment accept dispatches a diegetic offer beat."],
    ...
    ["Altmer alignment surface", "Your soul records where you stand in the Thalmor question: ", "Altmer Thalmor-alignment band writes a Chronicle line."],
