...
Int Property SIGNAL_TREACHERY = 2004 AutoReadOnly           ; anti-creed (medium): cowardice / dishonorable betrayal of the test
...
Float Property DELTA_TREACHERY = -3.0 Auto
...
Float Function ScoreCuratedSignal(Int signalType, Form contextRef)
    ...
    elseIf signalType == SIGNAL_TREACHERY
        return DELTA_TREACHERY
