...
- **Trinimac** - the unbroken warrior-god, the spirit of civilization defended by force. He stands behind the most orthodox, enforcement-minded path, and you can commit to him if you are willing to pay for that stance; his is the hardest Altmer road to walk.

One more figure shapes Altmer faith without being a patron you can commit to. **Syrabane**, the Apprentice-God of wards and protective magic, is honored in Altmer lore but has no path you can walk in play yet. And foreign gods matter mostly as pressure: anything tied to **Lorkhan**, **Shor**, **Talos**, or the Nordic divine frame works against your coherence rather than for it.
...
Your start is a position you hold, not a ladder you climb. The track moves in one direction: heresy pulls you down it, toward the Old Ways end. Reading a banned text, taking up a Daedric artifact, or killing a Thalmor agent unprovoked all slide you away from orthodoxy, and the Daedric artifact is by far the heaviest of the three. Nothing pushes you back up. So an Orthodox Altmer who consorts with Daedra and reads what the Dominion forbids does not merely lose ground; they become theologically incoherent, and the track shows it.

The track has one hard bite on your faith: it scales the Lorkhan pressure. The higher you sit toward the enforcer pole, the harder the great mortal-world moments land on you. Slide heterodox and they land softer. That is the trade the Altmer live with.
...
- **Read the sacred texts.** The great books of your ancestors are where the dawn actually reaches you. The first time you read a given sacred text it lands with real weight: the works of Auri-El renew the dawn itself, works of arcane theory feed Magnus, and works of lineage and record feed Xarxes. This is also the practice that keeps you out of neglect - see below.
- **Study with discipline.** Ordinary reading feeds your scholar gods too, in smaller measure. Spell tomes please Magnus; lore and skill books please Xarxes and Auri-El.
- **Reach a magic milestone with restraint.** Advancing a school of magic as a marker of mastery, rather than casting the same spell over and over, honors Magnus. Each school rewards you as you cross into real competence, mastery, and beyond - Alteration, Conjuration, Destruction, Enchanting, Illusion, and Restoration all count. This is finite, study-framed progress, not button-mashing: each threshold pays once.
- **Advance with discipline.** Mastering a skill, completing an enchantment, learning a Word of Power, brewing a potion, putting down the undead, healing or curing someone, resting under the open sky: these all read as disciplined self-perfection toward the ascent.
...
|-------|--------------|--------|
| Dragon Rising | Slew Mirmulnir and were declared Dragonborn - the signature Lorkhan crisis | Hurts - large |
| Sovngarde | Entered Shor's mortal-hero afterlife | Hurts - large |
| Proving Honor | Took the Companions' beast-blood fork | Hurts - large |
| The Eye of Magnus | Kept disciplined custody of the Eye | Helps Magnus |

**Auri-El**

| Quest | What you did | Effect |
|-------|--------------|--------|
| Glory of the Dead | Honored the fallen with rites | Helps - small |
| Alduin's Bane | Turned back the devourer of elven time | Helps - small |
| Dragonslayer | The World-Eater unmade, order upheld | Helps - small |
| The Way of the Voice | Disciplined mastery of the Voice | Helps - small |
| The Horn of Jurgen Windcaller | Passed the Greybeards' final trial | Helps - small |

**Magnus**

| Quest | What you did | Effect |
|-------|--------------|--------|
| Discerning the Transmundane | Recovered lost arcane knowledge | Helps - small |
| First Lessons | Entered the College and took up disciplined study | Helps - small |
| Under Saarthal | Recovered buried knowledge | Helps - small |
| Hitting the Books | Recovered the stolen Fellglow books | Helps - small |
| Good Intentions | Heeded the Augur | Helps - small |
| Revealing the Unseen | Revealed the Staff at the Oculory | Helps - small |
| The Staff of Magnus | Recovered the Staff | Helps - milestone |
| The Eye of Magnus | Contained the Eye and were named Arch-Mage | Helps - milestone |
...
| Quest | What you did | Effect |
|-------|--------------|--------|
| Glory of the Dead | Honored the fallen Harbinger | Helps - milestone |
| The College of Winterhold arc (First Lessons through The Staff of Magnus) | Knowledge recovered into the ledger | Helps - small |
| The Way of the Voice | Disciplined study of the Words | Helps - small |
| The Book of Love | Entered two reunited souls into the ledger | Helps - small |
| The Taste of Death | Defiled the recorded dead | Hurts - small |

## Bonuses by Tier

Your reward comes in two layers. The **Orthodox foundation** is your always-on, broad-coherence reward; it caps at Devoted and goes quiet once you commit to a single patron. Then each focused patron carries its own three-tier set that climbs all the way to Champion. Reaching Seeker is 25 piety, Devoted is 50, and Champion is 85.

**Orthodox foundation** - you keep to the ancestral order. Broad coherence, caps at Devoted.

| Tier | What you get |
|------|--------------|
| Seeker (25) | Fortify Magicka +15 |
| Devoted (50) | Fortify Magicka +25, Magic Resistance +5% |

**Auri-El's Dawn** - the road back, open to every faction.

| Tier | Blessing | What you get |
|------|----------|--------------|
| Seeker (25) | Auri-El's Dawn | Fortify Magicka +15 |
| Devoted (50) | Auri-El's Dawn | Fortify Magicka +25, Magic Resistance +6% |
| Champion (85) | Auri-El's Return | Fortify Magicka +40, Magic Resistance +16% |

**Magnus's Arts** - the architect's discipline.

| Tier | Blessing | What you get |
|------|----------|--------------|
| Seeker (25) | Magnus's Arts | Alteration +5 |
| Devoted (50) | Magnus's Arts | Alteration +13, Fortify Magicka +25 |
| Champion (85) | Magnus's Aperture | Alteration +25, Fortify Magicka +40 |

**Xarxes's Record** - the ageless ledger.

| Tier | Blessing | What you get |
|------|----------|--------------|
| Seeker (25) | Xarxes's Record | Restoration +5 |
| Devoted (50) | Xarxes's Record | Restoration +13, Fortify Magicka +25 |
| Champion (85) | Xarxes's Ledger | Restoration +25, Fortify Magicka +40 |

**Trinimac's Charge** - the warrior-god's orthodox strength, for those who take the hardest road.

| Tier | Blessing | What you get |
|------|----------|--------------|
| Seeker (25) | Trinimac's Charge | One-Handed +5 |
| Devoted (50) | Trinimac's Charge | One-Handed +13, Armor +15 |
| Champion (85) | Trinimac's Defense | One-Handed +25, Armor +50 |
...
**Lorkhan pressure.** This is what makes Altmer feel like no other race. A handful of explicit, enormous choices carry a theological cost because of what they mean to an Altmer, not because a god is angry with you. The friction does not ask permission; when the moment arrives, it fires. The real question it puts to you is: how much of Skyrim are you willing to forgo on Altmer terms? Some players turn down the main quest's later beats for theological reasons. Some walk through them and accept the cost. Neither is wrong, but neither is free. Crucially, ordinary existence is never taxed. Walking through Nord towns, having Nord friends, sleeping indoors, doing ordinary quests, and simply being Dragonborn after the first crisis beat all stay silent. There is no hidden debt for living.

**Coherence over volume.** Most races reward you for piling up devotion. Altmer rewards you for holding a shape. Your faction lean, your alignment track, and your patron focus all want to point the same direction, and the track only ever moves away from orthodoxy, so holding an orthodox line means refusing what would pull you off it. Because broad worship caps you at Devoted, and because the great mortal-world moments keep taking their cut, an Altmer who engaged carelessly with Skyrim's content will plateau at Devoted and struggle to push into Champion. Reaching Champion as an Altmer is the strongest statement in the mod: you navigated recurring pressure, kept your devotion positive, and held faith anyway.

## If You Are Cursed (Vampire or Werewolf)

| Curse | What happens to your faith |
|-------|----------------------------|
| **Vampire** | Auri-El closes completely. To shrink from the sun is to shrink from the god of return, and the records expunge a vampire from the bloodline. Your magic still works, but it loses its religious framing and becomes mere power. There is no cure-and-restore arc for an Altmer vampire, unlike some other races. The active exile state clears ordinary favor and suppresses dawn, orthodoxy, and heritage gains; a cure reopens those earns while leaving a scar. |
| **Werewolf** | This is the most theologically annihilating fate in all of Tamriel. The beast-state is the exact inverse of the Apotheosis project: the maximum possible movement away from becoming spirit again. There is no heretical theology to soften it, not even the lowest cap that vampirism gets. Devotion halts entirely, with no path forward in any direction. Only a cure lifts it. |

## Quick Reference

- **Gods:** Auri-El (foundation, always on), Magnus, Xarxes, and Trinimac (the hard orthodox road); Daedra forbidden.
...
- **Top 3 ways to gain:** Read the sacred texts (Auri-El, Magnus, Xarxes); study widely, spell tomes and lore alike (Magnus, Xarxes); reach magic milestones with restraint (Magnus).
- **Main ways to lose:** Lorkhan pressure from the great mortal-world moments (being declared Dragonborn, Sovngarde, the Companions' beast-blood fork); accepting Daedric artifacts; murder and necromancy; neglect, if you stay away from the sacred texts too long.
