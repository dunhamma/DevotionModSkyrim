...
| Hermaeus Mora | 26 | - | 17 | [Daedric_HermaeusMora_Review.md](Daedric_HermaeusMora_Review.md) | [Daedric_HermaeusMora_Review.csv](Daedric_HermaeusMora_Review.csv) |
| Mehrunes Dagon | 26 | - | 17 | [Daedric_MehrunesDagon_Review.md](Daedric_MehrunesDagon_Review.md) | [Daedric_MehrunesDagon_Review.csv](Daedric_MehrunesDagon_Review.csv) |
| Sheogorath | 26 | - | 17 | [Daedric_Sheogorath_Review.md](Daedric_Sheogorath_Review.md) | [Daedric_Sheogorath_Review.csv](Daedric_Sheogorath_Review.csv) |
| Clavicus Vile | 26 | - | 17 | [Daedric_ClavicusVile_Review.md](Daedric_ClavicusVile_Review.md) | [Daedric_ClavicusVile_Review.csv](Daedric_ClavicusVile_Review.csv) |
| Vaermina | 26 | - | 17 | [Daedric_Vaermina_Review.md](Daedric_Vaermina_Review.md) | [Daedric_Vaermina_Review.csv](Daedric_Vaermina_Review.csv) |
...
1. Open the MD for a race or Prince to read drafted strings in moment-order with full authoring context (deity/Prince tone, voice, char cap).
2. Edit in the right-hand `Edit` column, or open the CSV in a spreadsheet for column sorting / filtering.
3. When happy with a batch of edits, hand-merge them back into the source manifest against the matching `Slot ID` -- `race-sheets/PDV_RaceContent_Manifest.md` for races, `race-sheets/PDV_DaedricContent_Manifest.md` for Princes.
4. Re-run `node tools/pdv_content_verify.mjs` to confirm budget / voice / ASCII still pass.
5. Re-run `node tools/pdv_writer_review.mjs` to regenerate this view from the updated manifests.

**Note.** Regenerating overwrites every `<Name>_Review.md` and `<Name>_Review.csv`. Save your in-progress `Edit` columns before re-running, or do your revising in a copy.