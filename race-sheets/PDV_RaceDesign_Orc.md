...
- **Mode ceiling implementation:** The ceiling difference isn't implemented as a hard cap on piety — it's a lower piety-per-day accumulation rate in ProcessDawn. City Orc gains 75% of Stronghold Orc's daily rate; Legion-exile gains 60%. These are rough targets for balancing — exact values TBD.
