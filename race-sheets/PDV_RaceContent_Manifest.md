...
| PDV_Msg_Nord_Shor_ChampionEntry | MessageBox | Marked | God-voice | 500/280 | TargetEndStates line 181; RaceDesign_Nord Section "Tier 3" | One-time on first Shor Devoted | Body: "Your sword stayed honest to the last blow, and Tsun has counted every fall. The seat I kept is yours now. When the bridge comes, you will not cross it as a stranger." Title: "Shor Keeps Your Seat" |
