...
> **Supersession notice (2026-08-20):** the status and counts below describe the historical flat
> extraction tranche, not current architecture. ORIGIN is now a wired polymorphic base plus ten
> race adapters selected through `PDV_FLST_OriginAdapters`; compile, VMAD, SEQ, and direct readback
> are green. Current ownership/count authority is generated by `tools/pdv_module_contract_sync.mjs`
> into `PDV_2_0ModuleContracts.manifest.json`. Preserve the remainder as tranche provenance.
