...
Next implementation-safe slice:
- Route proof is closed for the four wired trigger proof ACTIs. Move Lorkhan tag routing, one-active-favor behavior, Exiled vampire cap, rejected-surface assertions, and first crisis playfeel into beta-playthrough proof.
```
