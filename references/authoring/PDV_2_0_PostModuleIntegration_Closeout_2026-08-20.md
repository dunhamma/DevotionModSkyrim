...
and DEBUG extraction. It was produced in
`.claude/worktrees/v3-origin-extraction` on `feature/v3-post-module-integration`. The local
primary integration branch is `feature/v3-big-update`; advance it only after this atomic
checkpoint is committed and accepted.
