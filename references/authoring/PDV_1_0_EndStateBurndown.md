...
| C-AUDIT-VERIFY | audits | machine-gate | PASS | last observed PASS 2026-07-09T03:04:00.280Z | Run node .\tools\pdv_1_0_endstate_gate.mjs --run (or pdv_verify.mjs directly) with the houseCARL bridge live. |
| C-AUDIT-CONTENT | audits | machine-gate | PASS | last observed PASS 2026-07-09T03:04:00.365Z | Run node .\tools\pdv_1_0_endstate_gate.mjs --run (or pdv_content_verify.mjs directly). |
...
| C-EXPMODE-BUILD | experience-mode | machine-gate | PASS | last observed PASS 2026-07-09T03:04:24.700Z | Run node .\tools\pdv_1_0_endstate_gate.mjs --run --only C-EXPMODE-BUILD (strict experience-mode verifier). |
...
| C-DISLIKE-DEBUFF-BUILD | dislike-consequence | machine-gate | PASS | last observed PASS 2026-07-09T03:04:30.183Z | Run node .\tools\pdv_1_0_endstate_gate.mjs --run --only C-DISLIKE-DEBUFF-BUILD (strict dislike-consequence audit: 14 domain spells, dispatch wiring, 3-domain cap, live ESP readback). Per-domain stings prove through C-FELT-FAMILY during the race sittings. |
