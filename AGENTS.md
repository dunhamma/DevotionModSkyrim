...
Two dated archives hold the older entries, each carrying a full index. Live
invariants from either are restated under Architecture Summary / Naming
Conventions; active process rules under Standing Rules above.

`archive/PDV_DecisionsLog_Archive_2026-05.md` -- foundational
...
intake, and the 2026-05-11 -> 2026-05-16 session notes.

`archive/PDV_DecisionsLog_Archive_2026-05_2026-07.md` -- 182 entries covering
2026-05-21 to 2026-07-15: pantheon parity and the shared substrate pacing
model, the Breton two-axis split, Khajiit lunar and Moon-power work, Bosmer
Green Way, the Prisma dashboard and Book of Days passes, quest-reaction
expansion, signal-surface equity, the Requiem felt-penalty backend, and the
run-up to the 1.0 co-test runbook.
