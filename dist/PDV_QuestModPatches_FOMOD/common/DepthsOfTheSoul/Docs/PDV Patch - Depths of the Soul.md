# Devotion Patch - Depths of the Soul

Teaches Devotion how the gods react to the outcomes of Depths of the Soul.

## What it needs
- Devotion (PlayerDevotion), with per-mod channel support (scans
  SKSE/Plugins/StorageUtilData/PlayerDevotion/Channels/).
- Dungeon Delver Mod.esp active in your load order.

## What it contains
- Matrix channel: PDV_QRM_DepthsOfTheSoul.json -- 1 row / 1 quest key (s40).
- Plugin: no.
