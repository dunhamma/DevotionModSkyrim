# Devotion Patch - Once We Were Here

Teaches Devotion how the gods react to the outcomes of Once We Were Here.

## What it needs
- Devotion (PlayerDevotion), with per-mod channel support (scans
  SKSE/Plugins/StorageUtilData/PlayerDevotion/Channels/).
- Once We Were Here - Quest Mod.esp active in your load order.

## What it contains
- Matrix channel: PDV_QRM_OnceWeWereHere.json -- 5 rows / 3 quest keys (s50, s60, s61).
- Plugin: yes (PDV_Patch_OnceWeWereHere.esp, ESL-flagged).
