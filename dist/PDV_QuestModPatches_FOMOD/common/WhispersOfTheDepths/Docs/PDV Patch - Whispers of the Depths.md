# Devotion Patch - Whispers of the Depths

Teaches Devotion how the gods react to the outcomes of Whispers of the Depths.

## What it needs
- Devotion (PlayerDevotion), with per-mod channel support (scans
  SKSE/Plugins/StorageUtilData/PlayerDevotion/Channels/).
- Slays-Many-Beasts Quest Mod.esp active in your load order.

## What it contains
- Matrix channel: PDV_QRM_SlaysManyBeasts.json -- 1 row / 1 quest key (s45).
- Plugin: yes (PDV_Patch_SlaysManyBeasts.esp, ESL-flagged).
