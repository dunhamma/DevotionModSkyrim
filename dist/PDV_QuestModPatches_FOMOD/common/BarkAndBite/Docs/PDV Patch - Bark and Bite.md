# Devotion Patch - Bark and Bite

Teaches Devotion how the gods react to the outcomes of Bark and Bite.

## What it needs
- Devotion (PlayerDevotion), with per-mod channel support (scans
  SKSE/Plugins/StorageUtilData/PlayerDevotion/Channels/).
- Tree Contract Mod.esp active in your load order.

## What it contains
- Matrix channel: PDV_QRM_BarkAndBite.json -- 5 rows / 2 quest keys (s25, s45).
- Plugin: no.
