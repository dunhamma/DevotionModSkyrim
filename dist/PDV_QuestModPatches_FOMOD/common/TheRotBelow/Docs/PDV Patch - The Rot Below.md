# Devotion Patch - The Rot Below

Teaches Devotion how the gods react to the outcomes of The Rot Below.

## What it needs
- Devotion (PlayerDevotion), with per-mod channel support (scans
  SKSE/Plugins/StorageUtilData/PlayerDevotion/Channels/).
- CJ03Elroy.esp active in your load order.

## What it contains
- Matrix channel: PDV_QRM_RotBelow.json -- 18 rows / 2 quest keys (s120, s130).
- Plugin: no.
