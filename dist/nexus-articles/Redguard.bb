[size=6][b]Redguard - sect, sword, and the duty owed to the dead[/b][/size]
...
[list]
[*][b]Tu'whacca[/b] - the guide of the dead, the soul-keeper who leads the fallen to the Far Shores. The god of death duty, wards, and restoration. He is at the heart of every Redguard's faith.
[*][b]HoonDing[/b] - the Make Way God, the Walker-Who-Makes-Way. He does not attend ordinary fights. He shows himself at the breakthrough: the dragon brought down, the great adversary who should have broken you.
[*][b]Leki[/b] - the Lady of Swords, saint of the Sword-Singers. She rewards discipline and craft - the true blade, the honed skill - not raw kills.
[/list]

The wider Yokudan inheritance you honor but cannot focus on: [b]Satakal[/b] (the Worldskin, the endless cycle of devouring and renewal), [b]Ruptga[/b] / Tall Papa (the first to find the Far Shores), [b]Tava[/b] (the bird-goddess of good passage and the open road), and [b]Onsi[/b] (the warrior who taught the people to draw swords). These four are cultural inheritance rather than gods you can serve directly.
...
At setup you choose your sect. This is the choice that gives your faith its shape and its burden. All three are equally faithful - they simply carry different weight.

[list]
[*][b]Crown[/b] - orthodoxy and bearing. You carry the old way intact, in exile, exactly as it was kept in Hammerfell: the blade, the bearing, the rites. You are the living proof the orthodoxy still works, and the ancestors are strong at your back for it.
[*][b]Forebear[/b] - adaptation and pragmatic survival. You make a life among outsiders and stay Redguard doing it. This is the broadest, most flexible road, and it is the fallback if your sect choice is ever lost.
[*][b]Ash'abah[/b] - funerary duty and impurity borne for others. You take up the unclean work no one else will touch: cleansing the undead, putting the restless dead to rest, opposing necromancy. Your own people are uncomfortable around you, but Tu'whacca honors the burden few will carry, and the ancestors stand closest to you of all.
[/list]

Your ancestor reverence is always on, in every sect. It is strongest for Ash'abah, strong for Crown, and moderate for Forebear. It quietly earns small piety from death-adjacent moments and hardens you against magic over time.

You can change sect later, but not casually. Moving between Crown and Forebear needs clear sect-fitting deeds on separate days, judged at dawn, and the change locks in for a few days afterward. Entering Ash'abah requires a real burden - a named undead lord or a named necromancer put down. Casual undead fighting is not enough, and you will not drift out of Ash'abah just because you had a quiet week.
...
[list]
[*][b]Defeat the undead[/b] - draugr, skeletons, ghosts. Ending the restless dead so they reach the Far Shores. This is the bread and butter of Tu'whacca devotion and of the ancestor layer. Daily capped; quality over quantity.
[*][b]Put down a great burden[/b] - a named undead lord or a named necromancer. These are the deeds that mark you as Ash'abah, and they pay far more than routine kills. Rank-and-file draugr and hedge-necromancers do not count as burdens.
[*][b]Clear a draugr tomb[/b] - finishing a notable barrow, boss included. Counts once per tomb, not per visit. It feeds both your death duty and your ancestral regard.
[*][b]Make a way[/b] (HoonDing) - bring down a dragon, or one of a short list of great adversaries, while HoonDing is your chosen patron. This is rare on purpose, and it is capped to one such moment per week. HoonDing does not notice ordinary victories, and he will not notice these ones either unless he is the god you have committed to.
[*][b]Keep the sword-song[/b] (Leki) - forge a true blade, sharpen your martial skill, study a book of arms, learn a word of power, or bring down a dragon. Leki cares about the discipline behind the blade. Simply winning fights does not feed her.
[*][b]Win honorable single combat[/b] (Leki) - meet a worthy foe in the open, no sneak opener, and fight it through to the end. Leki honors the duel itself, not the corpse count; repeated duels in one day mean less and less to her.
[*][b]Honor the ancestors[/b] - read the approved book of your people's arms, the [i]Manual of Mixed Unit Tactics[/i], or take your rest where the dead are properly honored. This lane needs no patron and no sect; it is always open to you.
[/list]
...
[list]
[*][b]Offenses.[/b] Raising the undead is the worst thing a Redguard can do - it chains souls back from the Far Shores, and it offends Tu'whacca and HoonDing both. Killing the defenseless shames all three of your gods. Assaulting those who cannot answer in kind, and stealing, have no place in Leki's discipline. Accepting a Daedric artifact binds a soul away from its proper passage and turns Tu'whacca's face from you. HoonDing also takes a dim view of soft nights bought in an inn.
[*][b]Neglect (a god growing quiet).[/b] Ignore the work and your gods do not punish you - they simply grow distant. The ancestors feel far away and the road feels colder; this shows up as a drop in your magic resistance until you take up the death duty again. Tu'whacca is still there - you are just not doing the work he needs done.
[*][b]The abandoned death duty.[/b] When the ancestors have been distant long enough, Tu'whacca reads it as a duty set down, and takes a hard, one-time cut from his own piety on top of the neglect. This is the sharpest loss on the Redguard road, and it is entirely in your hands to avoid.
[*][b]Natural drift.[/b] If you stop earning with a god, that god's piety slowly settles back over time. This is gentle - it keeps your standing honest, not punishing.
[*][b]The broad-worship cap.[/b] Honoring your sect broadly, across many Yokudan gods, can only carry you to Devoted. To reach Champion you must commit to a single focused god - Tu'whacca, HoonDing, or Leki. While you are committed, your broad ancestor blessing steps aside so the focused god's gifts can lead.
[/list]
...
Your gifts grow as you climb from [b]Seeker[/b] (25 piety) to [b]Devoted[/b] (50) to [b]Champion[/b] (85). Only the highest tier you have reached is active - the tiers do not stack.

Beneath any focused god sits the always-on [b]Ancestor Spine[/b], shared across all sects and capped at Devoted: a steady ward against magic, and armor besides as it deepens. It steps aside while a focused god leads, because the focused god's gifts are stronger.

Each of the three focusable gods carries its own flavour:

[list]
[*][b]Tu'whacca[/b], the soul-keeper (best fit for Crown and Ash'abah), wards you against magic. From Devoted his gift also carries a [b]special power[/b]: whenever you keep a death-rite - putting the restless dead to rest, or carrying a Far Shores token - he restores a flat measure of your health, once a day, larger at Champion. It is a true heal, not a rate bonus, so you feel it even under Requiem: the Far Shores kept open for you and yours.
[*][b]HoonDing[/b], the way made (best fit for Forebear), sharpens your sword-arm and quickens your step. His [b]Champion gift is Redguard's one cheat-death[/b]: "HoonDing Makes Way" - once a day, a lethal blow is refused and the god opens the road back from the edge. He does not do it twice in a day, and only for the god you have truly committed to.
[*][b]Leki[/b], the sword-song (best fit for Crown and Forebear), rewards the honed blade - one-handed skill and, higher up, a growing edge of critical bite.
[/list]
...
[list]
[*][b]Vampire[/b] [i]Near-total collapse. Undeath is a soul that has stepped out of the cycle Tu'whacca guides, so the Far Shores cannot receive you. The ancestors turn their faces away for as long as the curse holds - you carry the full distance loss to your magic resistance, and Tu'whacca reads your death duty as abandoned. Your sect identity remains only as memory and grief.[/i] - Yes, and it is meaningful. When the curse is cured the cycle closes again: the ancestors' distance lifts, Tu'whacca receives you back first, before any other god, and the Far Shores are open to you once more. Your sect will have you back.
[*][b]Werewolf[/b] [i]Strained, not severed. The Yokudan gods and your sect stay within reach, but favor is harder to keep - Hircine is an intrusion into Redguard life, not a home or an alternative. The condition stays theologically homeless. The ancestors do not turn away; they only watch the closer.[/i] - Yes. When the beast is set down, the strain eases and the gods come back into full reach. The ancestors who watched the closer ease their gaze, and you are wholly theirs again.
[/list]

[size=5][b]Quick Reference[/b][/size]

[list]
[*][b]Gods:[/b] Yokudan pantheon. Focusable: Tu'whacca, HoonDing, Leki. Background inheritance: Satakal, Ruptga, Tava, Onsi.
[*][b]Starting choice:[/b] Sect at setup - Crown (orthodoxy and bearing), Forebear (pragmatic adaptation), or Ash'abah (funerary duty, cleansing the undead). Ancestor reverence is always on regardless.
[*][b]Top ways to gain:[/b] Defeat the undead and clear draugr tombs; put down named undead lords and named necromancers; keep Leki's discipline (forge, train, learn, slay dragons); honor the ancestors through the approved book of arms and proper rest.
[*][b]Main ways to lose:[/b] Raising the undead, killing the defenseless, assault, theft, accepting Daedric artifacts; letting the ancestors grow distant, which brings both the magic-resistance loss and Tu'whacca's judgment that the death duty is abandoned; spreading too thin, since broad worship caps at Devoted.
[*][b]Rough days to Champion:[/b] About 30 to 45 days of normal play (one or two devotional acts a day), or roughly 20 if you focus hard on a single god.
[/list]
