[size=6][b]Khajiit - The Lattice holds you, even in exile[/b][/size]
...
[list]
[*][b]Khenarthi[/b] - goddess of wind, weather, and the open road. The most natural fit for a wandering Khajiit, and the one who guides lost souls home.
[*][b]Azurah[/b] - the mother-goddess who shaped the Khajiit and guards their passage through thresholds, dawn, and dusk. Her gift is Azura's Star.
[*][b]Baan Dar[/b] - the Bandit God, patron of pariahs, clever exiles, and improbable reversals. He smiles on the outsider who survives against the odds.
[*][b]Rajhin[/b] - the Purring Liar, the greatest thief who ever lived. His domain is artful, elegant theft, never crude violence.
[*][b]Alkosh[/b] - the Dragon King and keeper of cosmic order, the check on chaos. The rarest focus to reach, reserved for those who fight dragons and keep the line against chaos.
[/list]
...
[list]
[*][b]The lunar bond.[/b] This is your baseline connection to the moons. It runs without any upkeep and gives you a small standing footing: the moons keep you hardy, with Disease Resistance +5%.
[*][b]Living the road keeps it strong.[/b] Sleeping outdoors, watching the moons after dark, walking the road into places you have never seen, and defending the caravans all keep that bond strong and feed your piety.
[*][b]The moon cycle is always turning.[/b] The Lattice follows the real visible moon in the sky on a 24-day cycle. Each phase belongs to one of the five focus gods (for example, the full moon belongs to Alkosh, the new moon to Rajhin). Once you have raised that god to the Devoted tier, their phase gives you a small bonus while it is in the sky. You do not have to wait for the "right" night to make progress - the phases just add a little extra timing for players who pay attention.
[/list]
...
[list]
[*][b][b]Vampire[/b][/b] [i]Your lunar standing becomes corrupted and weakened, but not destroyed - the Lattice still holds you, just under strain. Caravan and community belonging drops sharply, because vampirism makes caravan life dangerous and unwelcome. Azurah may still read you with some mercy, since her relationship with the undead is complicated.[/i] - Yes. Curing the vampirism lifts the corruption and lets ordinary moon-life and caravan trust recover. Feeding offends Khenarthi, Azurah, and Rajhin, so the longer you feed, the further you slip.
[*][b][b]Werewolf[/b][/b] [i]Your lunar standing becomes strained but stays mostly intact. The moons are about form, and the werewolf is a competing form, not an opposite one, so Hircine adds a shape without severing your Khajiit identity. Caravan and community belonging is damaged because a werewolf is a threat to the people. It should feel uncomfortable and socially costly, not spiritually erased.[/i] - Yes. Curing the lycanthropy eases the strain. The Khajiit have more theological room for shape-complexity than most races, so recovery is cleaner here than the curse is for many others.
[/list]

[size=5][b]Quick Reference[/b][/size]

[list]
[*][b]Gods:[/b] Khenarthi, Azurah, Baan Dar, Rajhin, Alkosh (with the always-on Lunar Lattice beneath them)
[*][b]Starting choice:[/b] None - you begin inside the Lunar Lattice automatically, and a focus emerges silently from how you live
[*][b]Top 3 ways to gain:[/b] sleep out under the open sky; observe the moons after dark; do your focus god's deeds (Khenarthi roads and mercy, Azurah twilight and soul-work, Baan Dar survival against the odds, Rajhin artful theft, Alkosh dragons and order)
[*][b]Main ways to lose:[/b] neglect (three days with no lunar act at all), acting against a god's dislikes (especially killing the helpless or raising the undead), letting your focus drift back to broad, and the broad-worship cap at Devoted
[*][b]Rough days to Champion:[/b] about 30 to 45 days of normal play, or around 20 if you focus hard on one god - and only if you let a single god clearly lead
[/list]
